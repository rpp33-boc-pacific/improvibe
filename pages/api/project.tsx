...
export default function alterProject(req: any, res: any) {
  ...
  if (req.method === 'POST') {
    ...
    const insertSong = `INSERT INTO projects (name, genre, likes, shares, public, user_id, song_path, date_created) VALUES ('${project.name}', ${project.genre}, 0, 0, false, ${project.user_id}, '${project.track}', CURRENT_TIMESTAMP) RETURNING id`;
