          ...
          <Container>
            <Box sx={{ marginLeft: '40px', marginTop: '40px' }}>
              <Image
                ...
                src={photoUrl || 'https://artscimedia.case.edu/wp-content/uploads/sites/79/2016/12/14205134/no-user-image.gif'}
                height={300}
                width={300}
        ...
        <Grid container item xs={8}>
          ...
          <Grid container item xs={12}>
            <Stack direction='row' spacing={1.5}>
              {songs.map((song: any, index: number) => <Grid item key={index}><SongTile key={index} song={song} user={userId} color='white' /></Grid>)}
            </Stack>
          </Grid>
        </Grid>
      </Grid>
